...
export const InteractiveTeamCard = ({
  ...
  return (
    <div className="h-full overflow-hidden rounded-2xl border border-border/60 bg-card/90 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-pink-500/60 group backdrop-blur-sm relative">
      ...
      <div className="relative h-64 overflow-hidden">
        {imageUrl ? (
          <Image
            fill
            alt={`${name} — ${position}`}
            className="object-cover grayscale contrast-125 brightness-105 transition-transform duration-300 group-hover:scale-105"
            priority={false}
